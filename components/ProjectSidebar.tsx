          ...
          return (
            ...
            >
              ...
              <Button
                ...
                className={cn(
                  "h-7 w-7 opacity-0 group-hover:opacity-100 text-text-secondary hover:text-error hover:bg-error/10 transition-all",
                  isActive && "text-primary/60 hover:text-error"
                )}
